    ...
    <SplitSection
      ...
      primarySlot={
        <div className="lg:pl-32 xl:pl-48 border-r-2 pr-8 border-primary text-right ">
          ...
          <p className="text-gray-700 mb-4">Implemente as ferramentas mais novas e modernas <br/> da Microsoft. Faça a gestão da sua empresa <br/> utilizando o Power BI, aplicativos mobile e web ou <br/> fluxos automatizados entre APIs.</p>
